...
* *Deploy {partner-product-short-name} into an existing VPC*. This option provisions Amazon EKS and {partner-product-short-name} in your existing AWS infrastructure.
