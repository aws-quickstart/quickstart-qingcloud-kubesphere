...
^|https://console.amazonaws.cn/cloudformation/home?region=cn-northwest-1#/stacks/new?stackName=Kubesphere&templateURL=https://aws-quickstart-cn-northwest-1.s3.amazonaws.com.cn/quickstart-qingcloud-kubesphere/templates/kubesphere-entrypoint-new-vpc.template[Deploy {partner-product-short-name} into an existing VPC on AWS into CN-Northwest-1 Region^]
//^|https://fwd.aws/Ep9b4[Deploy {partner-product-short-name} into a New VPC on AWS into CN-Northwest-1 Region^]
