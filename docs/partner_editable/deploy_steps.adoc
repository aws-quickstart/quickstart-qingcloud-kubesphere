...
^|https://aws-quickstart-us-east-1.s3.amazonaws.com/quickstart-qingcloud-kubesphere/templates/kubesphere-entrypoint-new-vpc.template.yaml[View Template^]

^|https://fwd.aws/XJaW5[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://aws-quickstart-us-east-1.s3.amazonaws.com/quickstart-qingcloud-kubesphere/templates/kubesphere-entrypoint-existing-vpc.template.yaml[View template^]
|===
