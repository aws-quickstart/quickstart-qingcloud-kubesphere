...
*A.* Choose the user name at the top-right corner of the console, and choose *User settings* to find the language options. KubeSphere console supports English, Spanish, simplified Chinese, and traditional Chinese.