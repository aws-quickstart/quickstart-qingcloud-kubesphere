...
*A.* Click the username at the top right corner of the console, select *User Settings*, and you can find the language option. KubeSphere Console supports English, Simplified Chinese, Spanish, and Traditional Chinese.
