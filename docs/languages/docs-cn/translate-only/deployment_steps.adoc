...
[start=5]
. 在*配置堆栈选项*页面，您可以为堆栈中的资源https://docs.aws.amazon.com/zh_cn/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html[指定标签^]（键值对）并https://docs.aws.amazon.com/zh_cn/AWSCloudFormation/latest/UserGuide/cfn-console-add-tags.html[设置高级选项^]。操作完成后，选择*下一步*。
