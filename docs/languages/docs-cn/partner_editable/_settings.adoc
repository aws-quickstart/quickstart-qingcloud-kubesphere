...
:quickstart-team-name: Test 2nd Lang
:quickstart-project-name: TEST2
:partner-product-name: TEST2
...
:quickstart-contributors: Toni Jone, {quickstart-team-name}
