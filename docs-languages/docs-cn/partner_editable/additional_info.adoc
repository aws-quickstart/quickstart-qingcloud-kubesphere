...
image::../../../docs/images/image4.png[Architecture,width=648,height=439]

[#KubeSphereLogin2]
.KubeSphere dashboard
[link=images/image5.png]
image::../../../docs/images/image5.png[Architecture,width=648,height=439]
...
image::../../../docs/images/image6.png[Architecture,width=648,height=439]

Choose the *ClusterConfiguration* resource page. Choose *···* from the list, and select *Edit YAML*.

image::../../../docs/images/image7.png[Architecture,width=648,height=439]
...
image::../../../docs/images/image8.png[Architecture,width=648,height=439]
